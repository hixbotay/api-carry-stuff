    ...
    */
    ...
    {                           
        ...
        function get($name,$default=null){
        	...
        	return $params->get($params,$default);
        }
        function init()
        {
			...
			$this->economy = $params->get('economy');
            ...
            $this->customersUsergroup = (int) $params->get('customers_usergroup', 2);
            $this->supplierUsergroup = (int) $params->get('supplier_usergroup');             
            $this->agentUsergroup = (int) $params->get('agent_usergroup', null);
            ...
            //
            $this->rsGender = (int) $params->get('rs_gender', 1);
            ...
            $this->psBag = (int) $params->get('ps_bag',0);
