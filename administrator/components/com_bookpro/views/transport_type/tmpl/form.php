...
JToolBarHelper::title('Account edit');
...
<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'tab1', JText::_('Details')); ?> 
       				...
       				<?php } else { ?>
        					...
        					<div class="controls">
        						<?php 
									...
									echo $this->form->getInput('user',null,$this->obj->user); 
        ...
        <?php } else { ?>
				...
				<div class="control-group">
					<label class="control-label" for="lastname"><?php echo JText::_('COM_BOOKPRO_CUSTOMER_EMAIL'); ?>
					</label>
					<div class="controls">
						<input class="text_area required" type="text" name="email" id="email" size="60" maxlength="255" value="<?php echo $this->customer->email; ?>" />
					</div>
				</div>
