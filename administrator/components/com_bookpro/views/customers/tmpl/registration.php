...
JToolbarHelper::title ( JText::_ ( 'COM_BOOKPRO_REGISTRATION' ), 'users' );
		...
		<table class="table table-striped ">
			<thead>
				<tr>
					...
					<th><?php echo JText::_('COM_BOOKPRO_CUSTOMER_VALIDATE_CODE'); ?>
					</th>
			...
			<tbody>
				...
				<?php } else { ?>
				    <?php for ($i = 0; $i < $itemsCount; $i++) { 
				    	$params = json_decode($this->items[$i]->params);
					...
					<td class="center"><input type="button" value="<?php echo JText::_('COM_BOOKPRO_CUSTOMER_APPROVE')?>"
					...
					<td class=""><?php if(isset($params->active_code)){echo $params->active_code;}?></td>
