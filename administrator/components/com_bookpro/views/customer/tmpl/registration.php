...
JToolBarHelper::apply ( 'customer.applyapprove',JText::_('COM_BOOKPRO_CUSTOMER_APPROVE') );
JToolbarHelper::cancel ( 'customer.cancelregister' );
	...
	<div class="span6">
       ...
       <?php } else { ?>
		...
		<div class="control-group">
			...
			<?php if($this->item->params['active_code']){?>
			<div class="control-group">
				<div class="control-label"><?php echo JText::_('COM_BOOKPRO_CUSTOMER_VALIDATE_CODE'); ?></div>
				<div class="controls"><?php echo $this->item->params['active_code'] ?></div>
			</div>
			<?php }?>
			<div class="control-group">
