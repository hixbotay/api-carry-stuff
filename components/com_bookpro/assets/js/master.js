...
function checkUsername(){
	...
	if(usr.length >= 4)
	{
		...
		jQuery("#statusUSR").html('<img src="'+siteURL+'components/com_bookpro/assets/images/loader.gif" align="absmiddle">&nbsp;Checking availability...');
	...
	{ 
		...
		jQuery(this).html('&nbsp;<img src="'+siteURL+'components/com_bookpro/assets/images/tick.png" align="absmiddle">');
	}  
	else
	{			
...
var email = jQuery("#email").val();
	...
	if (p<1 || p==(email.length-1) || p1<1 || p1==(email.length-1))
	{
		...
		jQuery("#statusEMAIL").html('&nbsp;<img src="'+siteURL+'components/com_bookpro/assets/images/warning.png" align="absmiddle">');		
	...
	else
		{
			...
			jQuery("#statusEMAIL").html('<img src="'+siteURL+'components/com_bookpro/assets/images/loader.gif" align="absmiddle">&nbsp;Checking availability...');
	...
	jQuery(document).ready(function($) {
						...
						$.ajax({
									...
									beforeSend : function() {
										$("div#statescontrol")
												.html(
														'<div align="center"><img src="'+siteURL+'components/com_bookpro/assets/images/loader.gif" /><div>');
									},
